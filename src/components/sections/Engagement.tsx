...
export function Engagement() {
  ...
  return (
    <Section id="engagement" className="border-t border-v-blue-400/10 bg-v-ink-950 scroll-mt-24">
      ...
      <div ref={root} className="mt-16 grid gap-px bg-v-blue-400/12 md:grid-cols-3">
        {engagement.map((e, i) => (
          <article
            key={e.model}
            data-model
            className="group relative bg-v-ink-950 p-8 transition-colors duration-500 hover:bg-v-ink-800 md:p-10"
          >
